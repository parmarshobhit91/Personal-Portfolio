...
const Footer = () => {
    return (
        <footer className="bg- text-white p-6 text-center">
            ...
            <div className="flex justify-center items-center w-full h-[80px] m-auto gap-6">
                <a href="https://github.com/parmarshobhit91" target="_blank">
                <img className="h-[32px]" src={githubLogo} alt="logo" />
                </a>
                <a href="https://www.instagram.com/_._shobhit?igsh=ZGtmd3NuNGJnd3Z1" target="_blank">
                    <img className="h-[32px]" src={instagramLogo} alt="logo" />
                </a>
                <a href="https://www.linkedin.com/in/shobhit-parmar-a38830339/" target="_blank">
